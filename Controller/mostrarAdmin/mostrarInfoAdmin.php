            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td>' . $f['rol_usuario'] . '</td>
                        <td>' . $f['clavemd'] . '</td>
                        <td><a href="modificarUsuario.php?id_user=' . $f['id_usuario'] . '" class="btn btn-success">Editar <i class="icofont-ui-edit"></i></a></td>
                        <td><a href="../../Controller/eliminarAdmin/eliminarUserAdmin.php?id_user=' . $f['id_usuario'] . '" class="btn btn-danger btnEliminacion">Eliminar <i class="icofont-ui-delete"></i></a></td>
                    </tr>
                ';
            }
        }
            ...
            echo '
                <form action="../../Controller/modificarAdmin/modificarUserAdmin.php" method="POST" enctype="multipart/form-data" name="actualizarPerfilForm">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            <button type="submit" class="btn btn-primary update btnActualizarPerfil">Modificar Datos</button>
                        </div>
                    </div>
                </form>
            ';
