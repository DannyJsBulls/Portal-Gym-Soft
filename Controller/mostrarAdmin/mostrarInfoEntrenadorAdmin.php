<?php
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td>' . $f['rol_usuario'] . '</td>
                        <td>' . $f['clavemd'] . '</td>
                        <td><a href="modificarEntrenador.php?id_user=' . $f['id_usuario'] . '" class="btn btn-success">Editar <i class="icofont-ui-edit"></i></a></td>
                        <td><a href="../../Controller/eliminarAdmin/eliminarEntrenadorAdmin.php?id_user=' . $f['id_usuario'] . '" class="btn btn-danger btnEliminacionEntrenador">Eliminar <i class="icofont-ui-delete"></i></a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarEntrenador(){
        ...
        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarAdmin/modificarEntrenadorAdmin.php" method="POST" enctype="multipart/form-data" name="actualizarEntrenadorForm">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            <button type="submit" class="btn btn-primary update btnActualizarEntrenador">Modificar Datos</button>
                        </div>
                    </div>
                </form>
            ';
