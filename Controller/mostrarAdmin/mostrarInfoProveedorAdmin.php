<?php
    ...
    function cargarProveedor(){
        ...
        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarAdmin/modificarProveedorAdmin.php" method="POST" enctype="multipart/form-data" name="actualizarProveedorForm">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            <button type="submit" class="btn btn-primary update btnActualizarProveedor">Modificar Datos</button>
                        </div>
                    </div>
                </form>
            ';
