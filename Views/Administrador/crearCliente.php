...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Registrar Cliente</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            ...
                                            <p class="parrafo-table">Por favor complete los campos para registrar un nuevo cliente</p>
                                        </div>
                                        <div class="card-body">
                                            <form action="../../Controller/registrarAdmin/registrarClienteAdmin.php" method="POST" enctype="multipart/form-data" name="registroClienteForm">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <button type="submit" class="btn btn-primary update btnRegistroCliente">Registrar Cliente</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script src="../Website-Externo/js/registrar/registrarCliente.js"></script>
