<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarActividadCodigo.php");
...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Registrar Inscripcion Libre de Actividad</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="../../Controller/registrarAdmin/registrarLibreAdmin.php" method="POST" name="registroInscripcionLiForm">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        ...
                                                        <input type="textarea" class="form-control" placeholder="Ingrese un comentario" name="comentarios_inscripcion_libre">
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>ACTIVIDAD</label>
                                                        <?php 
                                                            // Verificar si se proporciono un codigo de actividad seleccionado en la url
                                                            $codigoActividadSeleccionada = isset($_GET['codigo_actividad']) ? $_GET['codigo_actividad'] : null;
                                                            // Llama a la funcion mostrarActividadCodigo con el codigo de actividad seleccionado
                                                            mostrarActividadCodigo($codigoActividadSeleccionada);
                                                        ?>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <button type="submit" class="btn btn-primary update btnRegistroInscripcionLi">Inscribir Actividad</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script src="../Website-Externo/js/registrar/registrarInscripcionLi.js"></script>
