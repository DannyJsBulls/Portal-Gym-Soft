<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarEntrenadorId.php");
...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Registrar Inscripcion Personalizada de Actividad</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            ...
                                            <p class="parrafo-table">Por favor complete los campos para registrar una inscripcion</p>
                                        </div>
                                        <div class="card-body">
                                            <form action="../../Controller/registrarAdmin/registrarPersoAdmin.php" method="POST" name="registroInscripcionPersoForm">
                                                <div class="row">
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        ...
                                                        <?php 
                                                            ...
                                                            mostrarEntrenadorId($idUsuarioSeleccionado);
                                                        ?>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>ACTIVIDAD</label>
                                                        <?php 
                                                            // Verifica si se proporcionó un codigo de actividad seleccionado en la URL
                                                            $codigoActividadSeleccionada = isset($_GET['codigo_actividad']) ? $_GET['codigo_actividad'] : null;
                                                            // Llama a mostrarActividadCoSelect con el codigo de actividad seleccionada
                                                            mostrarActividadCoSelect($codigoActividadSeleccionada);
                                                        ?>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>FECHA INICIO ACTIVIDAD</label>
                                                        <input type="date" class="form-control" placeholder="Ingrese la fecha" name="fecha_inicio_actividad">
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>HORA INICIO ACTIVIDAD</label>
                                                        <input type="time" class="form-control" placeholder="Ingrese la hora" name="hora_inicio_actividad">
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        ...
                                                        <input type="textarea" class="form-control" placeholder="Ingrese un comentario" name="comentarios_inscripcion_perso">
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>NUMERO PLAN</label>
                                                        <input type="number" class="form-control" placeholder="Ingrese el numero del plan" name="codigo_venta_plan">
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>CLIENTE</label>
                                                        <?php 
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <button type="submit" class="btn btn-primary update btnRegistroInscripcionPerso">Inscribir Actividad</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script src="../Website-Externo/js/registrar/registrarInscripcionPerso.js"></script>
