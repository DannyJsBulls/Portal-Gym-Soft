...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Registrar Plan</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            ...
                                            <p class="parrafo-table">Por favor complete los campos para registrar un plan</p>
                                        </div>
                                        <div class="card-body">
                                            <form action="../../Controller/registrarAdmin/registrarPlanesAdmin.php" method="POST" name="registroPlanForm">
                                                <div class="row">
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <label>NUM.REFERENCIA PLAN</label>
                                                        <input type="number" class="form-control" placeholder="Ingrese un numero de un plan" name="codigo_plan" required>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-6">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Ingrese un porcentaje de ganancia" name="porcentaje_ganancia_plan" step = "0.1">
                                                    </div>
                                                    <!--<div class="form-group col-lg-4 col-md-6">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <button type="submit" class="btn btn-primary update btnRegistroPlan">Registrar Plan</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script src="../Website-Externo/js/registrar/registrarPlan.js"></script>
