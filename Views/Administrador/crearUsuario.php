...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Registrar Usuario</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            ...
                                            <p class="parrafo-table">Por favor complete los campos para registrar un nuevo usuario</p>
                                        </div>
                                        <div class="card-body">
                                            <form action="../../Controller/registrarAdmin/registrarUserAdmin.php" method="POST" enctype="multipart/form-data" name="registroUserForm">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-6">
                                                        <button type="submit" class="btn btn-primary update btnRegistroUser">Registrar Usuario</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script src="../Website-Externo/js/registrar/registrarUser.js"></script>
