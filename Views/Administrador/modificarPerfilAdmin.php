...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Actualizar Perfil</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Formulario de Actualizacion Perfil de Usuario</h1>
                                            <p class="parrafo-table">Por favor modifique los campos para actualizar la informacion del usuario</p>
                                        </div>
                                        <div class="card-body">
                                            <?php 
        ...
        <script src="../Website-Externo/js/actualizar/actualizarPerfil.js"></script>
