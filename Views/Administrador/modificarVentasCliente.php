...
<html lang="es">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Actualizar Pedido De Producto a cliente</h1>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            ...
                                            <p class="parrafo-table">Por favor modifique los campos para actualizar la informacion del pedido del producto a cliente</p>
                                        </div>
                                        <div class="card-body">
                                            <?php 
        ...
        <script src="../Website-Externo/js/actualizar/actualizarPagoProductoCliente.js"></script>
