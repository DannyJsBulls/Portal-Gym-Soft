...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Actividades Registradas En El Sistema</h1>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarActividadAdmin">
                                        Registrar Actividad <i class="icofont-gym-alt-2"></i>
                                    </button>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verActividadAdmin">
                                        Ver Lista De Actividades <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Actividades</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionActividad.js"></script>
        ...
        <script>
            document.getElementById("registrarActividadAdmin").addEventListener("click", function() {
                window.location.href = "crearActividades.php";
            });

            document.getElementById("verActividadAdmin").addEventListener("click", function() {
                window.location.href = "verActividadesAdmin.php";
            });
        </script>
    </body>
</html>