                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Actividades disponibles en el gimnasio</h1>
                                </div>
                                <!-- <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Actividades Del Gimnasio</h1>
                                            <p class="parrafo-table">Por Favor seleccione la accion que desea realizar</p>
                                        </div>
                                        <?php 
                                            mostrarActividadesAdministrador();
                                        ?>
                                    </div>
                                </div>
                            </div>
