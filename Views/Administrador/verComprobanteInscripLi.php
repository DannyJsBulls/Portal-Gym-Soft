<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarInscripLibreAdmin.php");
...
<html lang="en">
    ...
    <body>
        <div class="d-flex">
            ...
            <div class="w-100">
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="button" onclick="imprimirComprobanteInscripLi()">
                    ...
                    <section class="bg-mix" id="comprobanteSectionLibre">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
        ...
        <script src="../Website-Externo/js/imprimirComprobanteLibre.js"></script>
