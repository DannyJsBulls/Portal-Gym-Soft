...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h1 class="font-weight-bold mb-0">Comprobante Inscripcion</h1>
                                </div>
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="button" onclick="imprimirComprobanteInscripPerso()">
                                        Imprimir Comprobante <i class="icofont-print"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section class="bg-mix" id="comprobanteSectionPerso">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <section id="planta">
                                            <div class="card-subtitle">
                                                <h1 class="title-recibo">Comprobante de la inscripcion en Linea</h1>
                                            </div>
                                        </section>
                                        <?php 
                                            cargarInscripcionPersoAdmin();
                                        ?>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="../Website-Externo/js/imprimirComprobantePerso.js"></script>
