    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Atividades del Gimnasio</h1>
                                </div>
                                <!-- <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Informacion De La Actividad</h1>
                                            <p class="parrafo-table">Por Favor seleccione la accion que desea realizar</p>
                                        </div>
                                        <?php 
                                            cargarActividadesAdministrador();
                                        ?>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // Busca todos los botones con la clase btnInscribirLibre
                var btnInscribirLibre = document.querySelectorAll('.btnInscribirLibre');

                // Añade un evento de clic a cada botón
                btnInscribirLibre.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        // Obtiene el valor del atributo data-actividad
                        var codigoActividad = this.getAttribute('data-actividad');

                        // Redirige al formulario crearOrdenCompras.php con el código de producto como parámetro
                        window.location.href = '../../Views/Administrador/crearInscripcionesLibres.php?codigo_actividad=' + codigoActividad;
                    });
                });
            }); 
        </script>
