    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Perfil de Entrenador</h1>
                                </div>
                                <!-- <div class="col-lg-3">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // Busca todos los botones con la clase btnInscripcionPerso
                var btnInscripcionPerso = document.querySelectorAll('.btnInscripcionPerso');

                // Añade un evento de clic a cada botón
                btnInscripcionPerso.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        // Obtiene el valor del atributo data-inscripcion
                        var idUsuario = this.getAttribute('data-inscripcion');

                        // Redirige al formulario crearInscripcionesPerso.php con el id de usuario como parámetro
                        window.location.href = '../../Views/Administrador/crearInscripcionesPerso.php?id_usuario=' + idUsuario;
                    });
                });
            });
        </script>
