...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h1 class="font-weight-bold mb-0">Remision del pedido</h1>
                                </div>
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="button" onclick="imprimirComprobantePlan()">
                    ...
                    <section class="bg-mix" id="comprobanteSectionPlan">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
        ...
        <script src="../Website-Externo/js/imprimirRemisionPlan.js"></script>
