...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h1 class="font-weight-bold mb-0">Remision pedido a proveedor</h1>
                                </div>
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="button" onclick="imprimirComprobante()">
        ...
        <script src="../Website-Externo/js/imprimirRemisionProvee.js"></script>
