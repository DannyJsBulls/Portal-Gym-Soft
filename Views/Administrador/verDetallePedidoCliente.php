...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Pedido Plan Cliente</h1>
                                </div>
                                <!-- <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="button" onclick="imprimirComprobanteCli()">
                                        Imprimir Recibo <i class="icofont-print"></i>
                                    </button>
                                </div> -->
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Pedido en Linea</h1>
                                        </div>
                                        <div class="card-body">
                                            <?php 
                                                cargarPedidosCli();
                                    ...
                                    <div class="card">
                                        <div class="card-title">
                                            <div>
                                                <h1 class="title-table">Plan Membresia(s)</h1>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <?php 
        ...
        <script>
            function obtenerClaseEstadoActual() {
                // Lógica para obtener la clase del estado actual desde la base de datos o donde sea necesario
                // Por ejemplo, podrías obtener la clase de un backend o un atributo en el HTML
                // Aquí simplemente asumo que tienes una variable con el estado actual
                var estadoActual = obtenerEstadoActual(); // Necesitas implementar esta función
                return 'paso-' + estadoActual;
            }

            function obtenerEstadoActual() {
                // Implementa la lógica para obtener el estado actual (puede ser una variable, una llamada AJAX, etc.)
                // Retorna el estado actual, por ejemplo 'comprado', 'enviado', 'entregado', etc.
                return 'comprado'; // Ejemplo, debes implementar esto según tu aplicación
            }
        </script>
    </body>
</html>