    ...
    <body>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Informacion Del Plan</h1>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // Busca todos los botones con la clase btnVenderPlan
                var btnVenderPlanDos = document.querySelectorAll('.btnVenderPlanDos');

                // Añade un evento de clic a cada botón
                btnVenderPlanDos.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        // Obtiene el valor del atributo data-plan
                        var codigoPlan = this.getAttribute('data-plan-dos');

                        // Redirige al formulario crearPagos.php con el código de plan como parámetro
                        window.location.href = '../../Views/Administrador/crearPagos.php?codigo_plan=' + codigoPlan;
                    });
                });
            });
