...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Productos del Gimnasio</h1>
                                </div>
                                <!-- <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Informacion Del Producto</h1>
        ...
        <script>
            // Evento para la funcion del cliente, registrar ventas clientes
            document.addEventListener('DOMContentLoaded', function () {
                // Busca todos los botones con la clase btnVenderProductoCli
                var btnVenderProductoCli = document.querySelectorAll('.btnVenderProductoCli');

                // Añade un evento de clic a cada botón
                btnVenderProductoCli.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        // Obtiene el valor del atributo data-producto-cli
                        var codigoProductoCli = this.getAttribute('data-producto-cli');

                        // Redirige al formulario crearOrdenCompras.php con el código de producto como parámetro
                        window.location.href = '../../Views/Administrador/crearVentasClientes.php?codigo_producto=' + codigoProductoCli;
                    });
                });
            });
        </script>
