    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Perfil de Proveedor</h1>
                                </div>
                                <!-- <div class="col-lg-3">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // Busca todos los botones con la clase btnComprarProducto
                var btnComprarProducto = document.querySelectorAll('.btnComprarProducto');

                // Añade un evento de clic a cada botón
                btnComprarProducto.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        // Obtiene el valor del atributo data-usuario
                        var idUsuario = this.getAttribute('data-usuario');

                        // Redirige al formulario crearOrdenCompras.php con el código de producto como parámetro
                        window.location.href = '../../Views/Administrador/crearOrdenCompras.php?id_usuario=' + idUsuario;
                    });
                });
            });
        </script>
