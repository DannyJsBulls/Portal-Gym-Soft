<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarUsuarioAdmin.php");
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Usuarios disponibles en el sistema</h1>
                                </div>
                                <!-- <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Usuarios Del Sistema</h1>
