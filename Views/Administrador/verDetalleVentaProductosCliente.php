                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h1 class="font-weight-bold mb-0">Remision pedido a cliente</h1>
                                </div>
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="button" onclick="imprimirComprobanteCli()">
                                        Imprimir Remision <i class="icofont-print"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section class="bg-mi" id="comprobanteSection">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <section id="planta">
                                            <div class="card-subtitle">
                                                <h1 class="title-recibo">Remision del Pedido en Linea</h1>
                                            </div>
                                        </section>
                                        <?php 
                                            cargarPagosProductosClientes();
                                        ?>
                                    </div>
                                </div>
                            </div>
