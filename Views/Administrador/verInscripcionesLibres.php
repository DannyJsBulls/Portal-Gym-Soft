...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h1 class="font-weight-bold mb-0">Inscripciones Libres de Actividades Registradas En El Sistema</h1>
                                </div>
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarInscripcionLibreAdmin">
                                        Registrar Inscipcion Libre <i class="icofont-gym-alt-2"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Inscripciones Libres de Actividades</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionInscripLibre.js"></script>
        ...
        <script>
            document.getElementById("registrarInscripcionLibreAdmin").addEventListener("click", function() {
