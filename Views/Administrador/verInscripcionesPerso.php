<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarInscripPersoAdmin.php");
...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h1 class="font-weight-bold mb-0">Inscripciones Personalizadas de Actividades Registradas En El Sistema</h1>
                                </div>
                                <div class="col-lg-3">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarInscripcionPersoAdmin">
                                        Registrar Inscipcion Personalizada <i class="icofont-gym-alt-2"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Inscripciones Personalizadas de Actividades</h1>
                                                ...
                                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>COMENTARIOS INSCRIPCION</th>
                                                            <th>NOMBRE ACTIVIDAD</th>
                                                            <th>NUMERO PLAN</th>
                                                            <th>NOMBRE CLIENTE</th>
                                                            <th>NOMBRE ENTRENADOR</th>
                                                            <th>COMPROBANTE INSCRIPCION</th>
                                                            <th>VER/EDITAR</th>
                                                            <th>ELIMINAR</th>
                                                        </tr>
                                                    </thead>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionInscripPerso.js"></script>
        ...
        <script>
            document.getElementById("registrarInscripcionPersoAdmin").addEventListener("click", function() {
