<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarPedidosProductosCliAdmin.php");
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Pedido Producto Cliente</h1>
                                </div>
                                <!-- <div class="col-lg-3">
