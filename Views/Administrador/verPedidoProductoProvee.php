<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarPedidosProductosProAdmin.php");
...
<html lang="en">
    ...
    <body>
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="font-weight-bold mb-0">Pedido Producto Proveedor</h1>
                                </div>
                                <!-- <div class="col-lg-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        <div class="card-title">
                                            <div>
                                                <h1 class="title-table">Producto(s)</h1>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <?php 
                                                cargarPedidosDetaProductoPro();
                                            ?>
                                        </div>
                                    </div>
                                    <div class="card">
        ...
        <script src="../Website-Externo/js/imprimirRemisionCliente.js"></script>
        ...
        <script>
            document.getElementById("registrarUserAdmin").addEventListener("click", function() {
                window.location.href = "crearUsuario.php";
            });

            document.getElementById("verUserAdmin").addEventListener("click", function() {
                window.location.href = "verDetalleUsuario.php";
            });
        </script>
    </body>
</html>