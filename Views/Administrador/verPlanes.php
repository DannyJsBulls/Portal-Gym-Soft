...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Planes Registrados En El Sistema</h1>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarPlanAdmin">
                                        Registrar Plan <i class="icofont-tags"></i>
                                    </button>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verPlanAdmin">
                                        Ver Lista De Planes <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Planes</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionPlan.js"></script>
        ...
        <script>
            document.getElementById("registrarPlanAdmin").addEventListener("click", function() {
                window.location.href = "crearPlanes.php";
            });

            document.getElementById("verPlanAdmin").addEventListener("click", function() {
                window.location.href = "verPlanesDetalle.php";
            });
        </script>
    </body>
</html>