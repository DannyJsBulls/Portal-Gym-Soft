...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Productos De Gimnasio Registrados En El Sistema</h1>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarProductoAdmin">
                                        Registrar Producto <i class="icofont-ui-rate-add"></i>
                                    </button>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verProductoAdmin">
                                        Ver Lista De Productos <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Productos de Gimnasio</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionProducto.js"></script>
        ...
        <script>
            document.getElementById("registrarProductoAdmin").addEventListener("click", function() {
                window.location.href = "crearProductos.php";
            });

            document.getElementById("verProductoAdmin").addEventListener("click", function() {
                window.location.href = "verProductosAdmin.php";
            });
        </script>
    </body>
</html>