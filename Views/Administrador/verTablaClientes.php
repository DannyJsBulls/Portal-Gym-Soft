...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Clientes Registrados En El Sistema</h1>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarClienteAdmin">
                                        Registrar Cliente <i class="icon ion-md-person-add"></i>
                                    </button>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verClienteAdmin">
                                        Ver Lista De Clientes <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Clientes</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionCliente.js"></script>
        ...
        <script>
            document.getElementById("registrarClienteAdmin").addEventListener("click", function() {
                window.location.href = "crearCliente.php";
            });

            document.getElementById("verClienteAdmin").addEventListener("click", function() {
                window.location.href = "verDetalleCliente.php";
            });
        </script>
    </body>
</html>