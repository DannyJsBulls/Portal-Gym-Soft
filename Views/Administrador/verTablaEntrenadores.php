...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Entrenadores Registrados En El Sistema</h1>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarEntrenadorAdmin">
                                        Registrar Entrenador <i class="icon ion-md-person-add"></i>
                                    </button>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verEntrenadorAdmin">
                                        Ver Lista De Entrenadores <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Entrenadores</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionEntrenador.js"></script>
        ...
        <script>
            document.getElementById("registrarEntrenadorAdmin").addEventListener("click", function() {
                window.location.href = "crearEntrenador.php";
            });

            document.getElementById("verEntrenadorAdmin").addEventListener("click", function() {
                window.location.href = "verDetalleEntrenador.php";
            });
        </script>
    </body>
</html>