<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarInfoProveedorAdmin.php");
...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Proveedores Registrados En El Sistema</h1>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="registrarProveedorAdmin">
                                        Registrar Proveedor <i class="icon ion-md-person-add"></i>
                                    </button>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verProveedorAdmin">
                                        Ver Lista De Proveedores <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Proveedores</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionProveedor.js"></script>
        ...
        <script>
            document.getElementById("registrarProveedorAdmin").addEventListener("click", function() {
                window.location.href = "crearProveedor.php";
            });

            document.getElementById("verProveedorAdmin").addEventListener("click", function() {
