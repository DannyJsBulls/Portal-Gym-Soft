...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../Dashboard/css/sweetalert/sweetalert.css">
    ...
    <body>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <h1 class="font-weight-bold mb-0">Usuarios Registrados En El Sistema</h1>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <button class="btn btn-primary w-100" type="submit" id="verUserAdmin">
                                        Ver Lista De Usuarios <i class="icofont-eye-alt"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h1 class="title-table">Tabla Informacion Usuarios</h1>
        ...
        <script src="../Website-Externo/js/eliminar/eliminacionUser.js"></script>
