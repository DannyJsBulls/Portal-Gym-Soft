...
function asignarEventoEliminacion() {
    ...
    document.addEventListener('click', function(e) {
        ...
        const btnEliminacionEntrenador = e.target.closest('.btnEliminacionEntrenador');
        if (btnEliminacionEntrenador) {
            e.preventDefault();

            Swal.fire({
                title: '¿Estás seguro de eliminar el entrenador?',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(btnEliminacionEntrenador.getAttribute('href'))
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Redirige a la página de entrenadores después de cerrar la alerta
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error al eliminar el entrenador',
                                    text: data.message
                                });
                            }
                        })
