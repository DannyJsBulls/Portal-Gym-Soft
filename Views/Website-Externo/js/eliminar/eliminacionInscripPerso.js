...
function asignarEventoEliminacion() {
    ...
    document.addEventListener('click', function(e) {
        ...
        const btnEliminacionInscripPerso = e.target.closest('.btnEliminacionInscripPerso');
        if (btnEliminacionInscripPerso) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(btnEliminacionInscripPerso.getAttribute('href'))
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Redirige a la página de inscripciones personalizadas después de cerrar la alerta
