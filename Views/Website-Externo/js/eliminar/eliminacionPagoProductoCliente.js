...
function asignarEventoEliminacion() {
    ...
    document.addEventListener('click', function(e) {
        ...
        const btnEliminacionPagoProductoCliente = e.target.closest('.btnEliminacionPagoProductoCliente');
        if (btnEliminacionPagoProductoCliente) {
            e.preventDefault();

            Swal.fire({
                title: '¿Estás seguro de eliminar el pedido del producto al cliente?',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(btnEliminacionPagoProductoCliente.getAttribute('href'))
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Redirige a la página de pedidos de productos de clientes después de cerrar la alerta
