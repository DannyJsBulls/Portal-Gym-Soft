...
function asignarEventoEliminacion() {
    ...
    document.addEventListener('click', function(e) {
        ...
        const btnEliminacionPagoProductoProvee = e.target.closest('.btnEliminacionPagoProductoProvee');
        if (btnEliminacionPagoProductoProvee) {
            e.preventDefault();

            Swal.fire({
                title: '¿Estás seguro de eliminar el pedido del producto al proveedor?',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(btnEliminacionPagoProductoProvee.getAttribute('href'))
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Redirige a la página de pedidos de productos de proveedores después de cerrar la alerta
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error al eliminar el pedido del producto',
                                    text: data.message
                                });
                            }
                        })
