...
function asignarEventoEliminacion() {
    ...
    document.addEventListener('click', function(e) {
        ...
        const btnEliminacionPlan = e.target.closest('.btnEliminacionPlan');
        if (btnEliminacionPlan) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(btnEliminacionPlan.getAttribute('href'))
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Redirige a la página de planes después de cerrar la alerta
