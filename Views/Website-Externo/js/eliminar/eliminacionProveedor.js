...
function asignarEventoEliminacion() {
    ...
    document.addEventListener('click', function(e) {
        ...
        const btnEliminacionProveedor = e.target.closest('.btnEliminacionProveedor');
        if (btnEliminacionProveedor) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(btnEliminacionProveedor.getAttribute('href'))
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Redirige a la página de proveedores después de cerrar la alerta
