function imprimirComprobanteInscripLi() {
    // Captura el contenido de la sección
    var contenidoSeccion = document.getElementById('comprobanteSectionLibre').outerHTML;

    // Abre una nueva ventana o pestaña con el contenido
    var ventanaImpresion = window.open('', '_blank');
    ventanaImpresion.document.write('<html><head><title>Comprobante Inscripcion Libre</title>');
