document.addEventListener('DOMContentLoaded', function () {
    const registroPagoProductoForm = document.querySelector("form[name='registroPagoProductoForm']");
    const btnRegistroPagoProducto = registroPagoProductoForm.querySelector(".btnRegistroPagoProducto");

    btnRegistroPagoProducto.addEventListener('click', async (e) => {
        e.preventDefault();

        const formData = new FormData(registroPagoProductoForm);

        try {
            const response = await fetch(registroPagoProductoForm.action, {
                method: registroPagoProductoForm.method,
                body: formData
            });
