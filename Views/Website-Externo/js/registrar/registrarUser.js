document.addEventListener('DOMContentLoaded', function () {
    const formRegistroUser = document.querySelector("form[name='registroUserForm']");
    const btnRegistroUser = formRegistroUser.querySelector(".btnRegistroUser");

    btnRegistroUser.addEventListener('click', async (e) => {
        e.preventDefault();
